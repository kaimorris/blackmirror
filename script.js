...
function toggleMovieModeFmf(elem){
...
function toggleMovieModeEntire(elem){
...
function toggleMovieModeBrb(elem){
...
function toggleMovieModeWhiteBear(elem){
...
function toggleMovieModeNosedive(elem){
...
function toggleMovieModePlaytest(elem){
...
function toggleMovieModeSanjun(elem){
...
function toggleMovieModeHated(elem){
